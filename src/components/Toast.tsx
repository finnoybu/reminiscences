// Bottom-center toast notification. Used by SelectionToolbar to flash
// "Bookmark saved" / "Note saved" / "Errata reported" messages. Ported
// verbatim from main:components/Toast.tsx.
